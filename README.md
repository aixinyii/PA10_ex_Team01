...
- 点folk，如图所示：![alt text](image-2.png)
#### 在紫猫里克隆项目
- 在紫猫里点左上角的 file，然后点 clone repository，如图所示：![alt text](image-3.png)
- 选择 folk 来的项目，然后选择目录，如图所示：![alt text](image-4.png)
- 等下载完成
#### 编辑项目
...
- 点 commit XX file to main 如图所示：![alt text](image-5.png)
